...
class FirstWork {
  ...
  static let answersList = ["количества тарелок и расстояния между ними",
    ...
    static let rightAnswers      = [1, 3, 1, 2, 2, 3, 1]
}
